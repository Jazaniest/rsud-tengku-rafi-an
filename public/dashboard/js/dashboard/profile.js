...
export async function initTelegram(profile) {
  ...
  const profileUser = document.getElementById('username').textContent;
  try {
    ...
    if (data.linked === true) {
      ...
      telegramButton.innerHTML = `
        ...
        <a id="telegram-link" href="https://t.me/rsudtr_bot?start=link:${profileUser}" target="_blank" class="file-btn mb-3">
